                    ...
                    <form className="text-white bg-[#1b181a] rounded-2xl h-3/4 w-full md:w-full lg:w-3/4">
                        ...
                        <div className="flex flex-col justify-center">
                            ...
                            {login ? (
                                ...
                                <label className="mx-6 mt-6 mb-2">Username</label>
                                <input type="text" className="border mx-6 mb-4 bg-[#1b181a] rounded-2xl p-1.5 border-white "></input>

                                <label className="mx-6 mb-2">email</label>
                                <input type="email" className="border  mx-6 mb-4 bg-[#1b181a] rounded-2xl p-1.5 border-white"></input>
                                <label className="mx-6 mb-2">Confirm-password</label>
                                <input type={showpass ? 'tcxt' : 'password'} className="border mx-6 mb-4 bg-[#1b181a] rounded-2xl p-1.5 border-white"></input>
                                <label className="mx-6 mb-2">password</label>
                                <input type={showpass ? 'text' : 'password'} className="border mx-6 mb-4 bg-[#1b181a] rounded-2xl p-1.5 border-white"></input>
                                <div className="mx-6">
