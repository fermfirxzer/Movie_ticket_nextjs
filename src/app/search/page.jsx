...
const Explore = () => {
    ...
    const handleEditClick = (movieId) => {
        localStorage.setItem('movieId', "66f50326189103c5a66d4885");
        router.push('/editmovie'); // Correct usage of router
    };
    console.log(movies);
    return (
        <div>
                    ...
                    {movies.map((movie, index) => (
                        <div key={index} className='flex flex-col w-[40%] md:w-[30%] lg:w-[20%] items-center justify-start'>
                            <div className="relative flex flex-col items-center w-full">
                                ...
                                <div onClick={() => { isAdmin ? handleEditClick(movie._id) : router.push('/showtime'); }}>
