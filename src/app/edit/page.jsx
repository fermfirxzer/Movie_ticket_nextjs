                ...
                <div className='flex flex-wrap  xl:w-full justify-center lg:justify-start'>
                    ...
                    <div className=" mx-6 mt-6 mb-2 w-80 h-80 ">
                        <div onClick={handleClick} className="cursor-pointer w-full  h-full bg-black p-1 rounded-xl ">
                            ...
                            {currentMovieInfo.imageUrl ? (
                                <img src={currentMovieInfo.imageUrl} alt="Uploaded" className="w-full h-full object-contain rounded-lg" />
                            ) : (
                        ...
                        <input id="fileInput" type="file" accept="image/*" className='hidden' name="imageUrl" onChange={handleImageChange}/>
                    </div>
