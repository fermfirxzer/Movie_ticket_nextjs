        ...
        <nav className='mx-auto'>
            <div className='p-5 px-12 flex justify-between items-center'>
                <div className='flex gap-6 items-center'>
                    ...
                    <div className='search-box items-center  border-white  border-0.5 rounded-md bg-black gap-1 px-1.5 hidden md:flex ml-4'>
                ...
                <div className='hidden md:flex md:gap-8 '>
                    ...
                    {islogin ? (
                        <div className='relative'>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className='w-8 h-7 cursor-pointer' fill="currentColor" onClick={(e) => { setShowuser(!showuser) }}><path d="M399 384.2C376.9 345.8 335.4 320 288 320l-64 0c-47.4 0-88.9 25.8-111 64.2c35.2 39.2 86.2 63.8 143 63.8s107.8-24.7 143-63.8zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256zm256 16a72 72 0 1 0 0-144 72 72 0 1 0 0 144z" /></svg>
